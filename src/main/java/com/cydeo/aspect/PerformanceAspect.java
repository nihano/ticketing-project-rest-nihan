...
public class PerformanceAspect {
    ...
    public Object aroundAnyExecutionTimeAdvice(ProceedingJoinPoint proceedingJoinPoint) {
        //this will give current time in milliseconds
        long beforeTime = System.currentTimeMillis();
        Object result = null;
        log.info("Execution starts: ");
        //now executing the real method
        ...
        //after my method is executed
        long afterTime = System.currentTimeMillis();

        log.info("Time taken to execute: {} ms - Method: {}"
                , (afterTime - beforeTime), proceedingJoinPoint.getSignature().toLongString() );
